...
public class UcanGemi extends DenizTasit implements HavaTasit {

    private static int nesne_sayisi = 0;
    private String id_no;

    public UcanGemi() throws IOException {
        id_no = idBul();
        DosyaKaydet("UcanGemi_" + id_no);

    }

    public UcanGemi(String marka, int hiz, int yolcu_sayisi, int fiyat, int uretim_yili, String renk) {
        setMarka(marka);
        setHiz(hiz);
